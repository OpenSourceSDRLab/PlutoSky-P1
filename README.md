...
The **PlutoSDR-MIMO** version is based on the official **ADALM-PLUTO**. The core components of PlutoSDR-MIMO are all the same as ADALM-PLUTO, and it is fully compatible with the official analogdevicesinc/plutosdr-fw firmware.
